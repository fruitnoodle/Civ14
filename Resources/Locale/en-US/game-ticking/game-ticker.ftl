...
game-ticker-player-join-game-message = Welcome to Civilization 14! If this is your first time playing, be sure to read the game rules, and don't be afraid to ask for help in LOOC (local OOC) or OOC.
game-ticker-get-info-text = Hi and welcome to [color=white]Civilization 14![/color]
...
latejoin-arrival-announcement = {$character} ({$job}) { CONJUGATE-HAVE($entity) } arrived!
latejoin-arrival-announcement-special = {$job} {$character} on deck!
latejoin-arrival-sender = World
